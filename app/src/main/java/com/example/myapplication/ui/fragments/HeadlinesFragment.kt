            ...
            when(response){
                is Resource.Success<*> -> {
                    ...
                    response.data?.let {newsResponse ->
                        ...
                        val totalPages = newsResponse.totalResults / com.example.myapplication.util.Constants.QUERY_PAGE_SIZE + 2
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val isTotalMoreThanVisible =
                totalItemCount >= com.example.myapplication.util.Constants.QUERY_PAGE_SIZE
